        ...
        <tr><td width=45% valign="top">
            ...
            <td width=53% valign="top">
                <table width=100% border="2px"  style="text-align: center; border-collapse: collapse;">
                    <tr height=50>
                        <td colspan="2">
                        <img src="ECOUNT.jpg" height=100px;>
                        </td>
                    </tr>
                    <tr>
...
<asp:TextBox ID="txtvos1" runat="server"   width="80%"></asp:TextBox>
    ...
    <asp:TextBox ID="txtlink1" runat="server"   width="80%"></asp:TextBox>
    <asp:TextBox ID="txttech1" runat="server"   width="80%"></asp:TextBox>
    <asp:TextBox ID="txtcorp1" runat="server"   width="80%"></asp:TextBox>
        <asp:TextBox ID="txtsec1" runat="server"   width="80%"></asp:TextBox>
