<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SCM_NoticeAddControl.ascx.cs" Inherits="Admin_SCM_NoticeAddControl" %><!--ADD.ascx.cs 연결-->
        ...
        <tr><td width=45% valign="top">
            ...
            <table width=100% border="2px" style="text-align: center; border-collapse: collapse;">
                <tr> <!--일련번호 칸-->
                    ...
                    <td ><b><asp:TextBox ID="txtTitle" runat="server" width="90%" disabled></asp:TextBox></b></td> <!-- DB 연결 -->
                </tr>
                ...
                <tr> <!-- 주소 칸 -->
                    <td height=58px; bgcolor="#efefef"><b>주소</b></td>
                    <td><b><asp:TextBox class="lang1" ID="txtlang1" runat="server"  height="40px" width="90%"></asp:TextBox></b></td> <!-- DB 연결 -->
                </tr>   
                <tr> <!-- TEL 칸 -->
                    <td height=30px; bgcolor="#efefef"><b>TEL</b></td>
                    <td><b><asp:TextBox class="ps" ID="txtps" runat="server"   width="90%"></asp:TextBox></b></td> <!-- DB 연결 -->
                </tr>
            ...
            <!-- 납기일자 칸 -->
                ...
                <tr>
                    ...
                    <td style="text-align: left; border-left: none;" width=50%><b><asp:TextBox ID="txtDead1" runat="server" Width="50%" class="auto-kal"></asp:TextBox></td> <!-- DB 연결 -->
                </tr>
                </table>
            ...
            <td width=53% valign="top">
                <table width=100% border="2px"  style="text-align: center; border-collapse: collapse;">
                    <tr height=50>
                        <td colspan="2">
                        <img src="ECOUNT.jpg" height=100px;>    <!-- 자사 이미지 -->
                        </td>
                    </tr>
                    <tr> <!-- 사업자등록번호 -->
...
<!-- 첫번째 줄 -->
        <tr style="text-align:center;">
            ...
            <td style="text-align: center;"><b><asp:TextBox ID="txtqty1" runat="server" class="qty1"  width="80%" style="text-align:right" onChange="total1(this), sum_vos(this)"></asp:TextBox></b></td> <!-- 수량 -->
            <td style="text-align: right;"><asp:TextBox ID="txtprice1" runat="server" class="price1" style="padding-right:4px;" onChange="total1(this), sum_vos(this)"></asp:TextBox></td> <!-- 단가 -->
            <td style="text-align: right;"><asp:TextBox ID="txtvos1" runat="server" class="vos1" style="padding-right:4px;"></asp:TextBox></td> <!-- 공급가액 -->
            <td style="text-align: right;"><asp:TextBox ID="txtvat1" runat="server" class="vat1" style="padding-right:4px;"></asp:TextBox></td> <!-- 부가세 -->
        </tr>
<!-- 두번째 줄 -->
        <tr style="text-align:center;">
            <td height="30px" style=>
            ...
            <td style="text-align: center;"><b><asp:TextBox ID="txtqty2" class="qty2" runat="server"   width="80%" style="text-align:right" onChange="total2(this), sum_vos(this)"></asp:TextBox></b></td>
             <td style="text-align: right;"><asp:TextBox ID="txtprice2" class="price2" runat="server" style="padding-right:4px;" onChange="total2(this), sum_vos(this)"></asp:TextBox></td> <!-- 단가 -->
            <td style="text-align: right;"><asp:TextBox ID="txtvos2" class="vos2" runat="server" style="padding-right:4px;"></asp:TextBox></td> <!-- 공급가액 -->
            <td style="text-align: right;"><asp:TextBox ID="txtvat2" class="vat2" runat="server" style="padding-right:4px;"></asp:TextBox></td> <!-- 부가세 -->
        </tr>
<!-- 세번째 줄 -->
        <tr style="text-align:center;">
            <td height="30px" style=>
            ...
            <td style="text-align: center;"><b><asp:TextBox ID="txtqty3" class="qty3" runat="server"   width="80%" style="text-align:right" onChange="total3(this), sum_vos(this)"></asp:TextBox></b></td>
             <td style="text-align: right;"><asp:TextBox ID="txtprice3" class="price3" runat="server" style="padding-right:4px;" onChange="total3(this), sum_vos(this)"></asp:TextBox></td> <!-- 단가 -->
            <td style="text-align: right;"><asp:TextBox ID="txtvos3" class="vos3" runat="server" style="padding-right:4px;"></asp:TextBox></td> <!-- 공급가액 -->
            <td style="text-align: right;"><asp:TextBox ID="txtvat3" class="vat3" runat="server" style="padding-right:4px;"></asp:TextBox></td> <!-- 부가세 -->
        </tr>
<!-- 네번째 줄 -->
        <tr style="text-align:center;">
            <td height="30px" style=>
            ...
            <td style="text-align: center;"><b><asp:TextBox ID="txtqty4" class="qty4"  runat="server"   width="80%" style="text-align:right" onChange="total4(this), sum_vos(this)"></asp:TextBox></b></td>
             <td style="text-align: right;"><asp:TextBox ID="txtprice4" class="price4" runat="server" style="padding-right:4px;" onChange="total4(this), sum_vos(this)"></asp:TextBox></td> <!-- 단가 -->
            <td style="text-align: right;"><asp:TextBox ID="txtvos4" class="vos4" runat="server" style="padding-right:4px;"></asp:TextBox></td> <!-- 공급가액 -->
            <td style="text-align: right;"><asp:TextBox ID="txtvat4" class="vat4" runat="server" style="padding-right:4px;"></asp:TextBox></td> <!-- 부가세 -->
        </tr>
<!-- 다섯번째 줄 -->
        <tr style="text-align:center;">
            <td height="30px" style=>
            ...
            <td style="text-align: center;"><b><asp:TextBox ID="txtqty5" class="qty5" runat="server"   width="80%" style="text-align:right" onChange="total5(this), sum_vos(this)"></asp:TextBox></b></td>
            <td style="text-align: right;"><asp:TextBox ID="txtprice5" class="price5" runat="server" style="padding-right:4px;" onChange="total5(this), sum_vos(this)"></asp:TextBox></td> <!-- 단가 -->
            <td style="text-align: right;"><asp:TextBox ID="txtvos5" class="vos5" runat="server" style="padding-right:4px;"></asp:TextBox></td> <!-- 공급가액 -->
            <td style="text-align: right;"><asp:TextBox ID="txtvat5" class="vat5" runat="server" style="padding-right:4px;"></asp:TextBox></td> <!-- 부가세 -->
        
        </tr>
    </table>

    <!-- 합계 (하단) -->
    <table width=97.7% border="3"style="border-collapse: collapse; margin-top:7px; text-align:center;" >
        <tr >
            <td bgcolor="#efefef" width="13%" align=center><b> 공급가액</b></td>
            <td align=right width="20%"><asp:TextBox ID="txttech1" runat="server" width="200px" class="tech1" runat="server" style="padding-right:4px;" onChange="total(this)"></asp:TextBox></td>
            <td bgcolor="#efefef" width="13%" align=center><b>VAT</b></td>
            <td align=right width="20%"><asp:TextBox ID="txtcorp1" runat="server"  width="200px" class="corp1" runat="server" style="padding-right:4px;"></asp:TextBox></td>
            <td bgcolor="#efefef" width="13%" style="text-align:center;"><b>합계</b></td>
            <td align=right width="21%"><asp:TextBox ID="txtsec1" runat="server"  width="200px" class="sec1" runat="server" style="padding-right:4px;"></asp:TextBox></td>
        </tr>
    </table>
...
<table width="98%" border="0">
      <tr><td><HR SIZE=1></td></tr>
                <tr><td align="right">
                        ...
                        <asp:ImageButton ID="btnCancel" runat="server" ImageUrl="~/Images/cancel_bt.gif" OnClick="btnCancel_Click" /> <!-- 취소 버튼 -->
                </td></tr>
            </table>
...
<table style="border: 1px solid #d7d7d7">
    <asp:TextBox ID="lblNoticeError" runat="server" ForeColor="Red"></asp:TextBox>
